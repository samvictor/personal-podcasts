...
#     return "<p>Script generated</p>"


# @https_fn.on_request(secrets=[OPENAI_KEY])
# def latest_ep_audio(req: https_fn.Request) -> https_fn.Response: 
    # print_in_red("last eps results:")
    # print(get_last_n_episodes(1))
    # latest_ep = get_last_n_episodes(1)[0]["data"]
    # # print_in_red("latest ep is:")
    # # print (latest_ep)
    ...
    # podcast_script = podcast_response 
